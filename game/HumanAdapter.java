...
public class HumanAdapter implements PlayerAdapter {
    private Human human;

    public HumanAdapter(int playerNum, Hand hand) {
        human = new Human(playerNum, hand);
    }
    
    
    public Card play(Hand hand, Oh_Heaven.Suit lead, Oh_Heaven.Suit trump, int bid, int tricks) {
        return human.play(hand, lead, trump);
    }
